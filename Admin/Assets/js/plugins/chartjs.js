              ...
              datasets: [
                  {
                      data: [100],
                      backgroundColor: 'rgba(100,100,100,0.1)',
                      borderColor: [theme.color.info, theme.color.warning],
                      borderWidth: 4
                  }
              ]
          }
              ...
              datasets: [
                  {
                      data: [100],
                      backgroundColor: 'rgba(100,100,100,0.1)',
                      borderColor: [theme.color.warning, theme.color.success],
                      borderWidth: 4
                  }
              ]
          }
              ...
              datasets: [
                  {
                      data: [100],
                      backgroundColor: 'rgba(100,100,100,0.1)',
                      borderColor: [theme.color.danger, theme.color.warning],
                      borderWidth: 4
                  }
              ]
          }
              ...
              datasets: [
                  {
                      data: [100],
                      backgroundColor: 'rgba(100,100,100,0.1)',
                      borderColor: [theme.color.danger, theme.color.info],
                      borderWidth: 4
                  }
              ]
          }
